...
Revision ID: a4dfdb9e9451
Revises: cdb59b22e1d7
Create Date: 2022-11-07 00:12:09.638605
...
revision = 'a4dfdb9e9451'
down_revision = 'cdb59b22e1d7'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('arenas_id_seq'::regclass)"), autoincrement=True, nullable=False),
